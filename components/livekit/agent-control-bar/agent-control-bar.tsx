          ...
          {visibleControls.microphone && (
            <div className="flex items-center gap-0">
              <TrackToggle
                ...
                pressed={local?.microphone?.enabled ?? false}
                disabled={local?.microphone?.pending ?? false}
          ...
          {capabilities.supportsVideoInput && visibleControls.camera && (
            <div className="flex items-center gap-0">
              <TrackToggle
                ...
                pressed={local?.camera?.enabled ?? false}
                pending={local?.camera?.pending ?? false}
                disabled={local?.camera?.pending ?? false}
                onPressedChange={() => local?.camera?.toggle?.()}
          ...
          {capabilities.supportsScreenShare && visibleControls.screenShare && (
            <div className="flex items-center gap-0">
              <TrackToggle
                ...
                pressed={local?.screenShare?.enabled ?? false}
                disabled={local?.screenShare?.pending ?? false}
                onPressedChange={() => local?.screenShare?.toggle?.()}
