...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset=".github/assets/agent-starters-screenshot-dark.png">
  <source media="(prefers-color-scheme: light)" srcset=".github/assets/agent-starters-screenshot-light.png">
  <img alt="App screenshot" src=".github/assets/agent-starters-screenshot-light.png">
</picture>
